...
train = pd.read_csv("../data/datasets/train_2split.csv", header = 0)
test = pd.read_csv("../data/datasets/test_2_split.csv", header = 0)
...
np.save("../data/datasets/train_tensor_2layer128.npy", train_vec, allow_pickle = True)
np.save("../data/datasets/test_tensor_2layer128.npy", test_vec, allow_pickle = True)

train_label = train["Synergy"].astype('int32').to_numpy()
test_label = test["Synergy"].astype('int32').to_numpy()

np.save("../data/datasets/train_label_2layer128.npy", train_label, allow_pickle = True)
np.save("../data/datasets/test_label_2layer128.npy", test_label, allow_pickle = True)
