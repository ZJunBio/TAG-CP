...
ce_similarity = pd.read_csv("../data/one_graph/gkernel_125cellsimlarity.csv", header=0, index_col=0)
...
np.save("../data/datasets/train_tensor.npy", train_vec, allow_pickle = True)
np.save("../data/datasets/val_tensor.npy", val_vec, allow_pickle = True)
np.save("../data/datasets/test_tensor.npy", test_vec, allow_pickle = True)
...
np.save("../data/datasets/train_label.npy", train_label, allow_pickle = True)
np.save("../data/datasets/val_label.npy", val_label, allow_pickle = True)
np.save("../data/datasets/test_label.npy", test_label, allow_pickle = True)